...
resource = Resource.create({ResourceAttributes.SERVICE_NAME: "AiWorkshopDemo"})
...
def get_span(name: str, attributes: types.Attributes = None):
    """Get a span with the given name."""
    tracer = trace.get_tracer(__name__)
    with tracer.start_as_current_span(name, attributes) as current_span:
